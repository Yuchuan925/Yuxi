...
class LocalResourceSampler:
    ...
    def __init__(self, compose_project: str, sandbox_prefix: str):
    ...
    def _sandbox_containers(self) -> list[str]:
        ...
        return [
            ...
            if name.startswith(self.sandbox_prefix)
        ]
    ...
    def _sandbox_network_count(self) -> int:
        ...
        return sum(name.startswith(self.sandbox_prefix) for name in output.splitlines())
...
async def async_main(args: argparse.Namespace) -> int:
    ...
    async with httpx.AsyncClient(
        ...
        resource_sampler = (
            LocalResourceSampler(args.compose_project, args.sandbox_prefix)
