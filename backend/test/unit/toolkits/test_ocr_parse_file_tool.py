...
async def test_ocr_parse_file_writes_markdown_to_outputs(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    thread_id = "thread-1"
    uid = "user-1"
    source_virtual_path = "/home/gem/projects/project-workdir-1/scan.png"
    ...
    output_virtual_path = "/home/gem/projects/project-workdir-1/outputs/ocr/scan.md"
...
async def test_ocr_parse_file_uses_default_engine(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    thread_id = "thread-1"
    uid = "user-1"
    source_virtual_path = "/home/gem/projects/project-workdir-1/uploads/upload.pdf"
...
async def test_ocr_parse_file_accepts_disable_for_pdf(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    thread_id = "thread-1"
    uid = "user-1"
    source_virtual_path = "/home/gem/projects/project-workdir-1/uploads/text-layer.pdf"
    _patch_sandbox_backend(monkeypatch, {source_virtual_path: b"fake pdf"})
    captured: dict[str, object] = {}
...
async def test_ocr_parse_file_rejects_directory(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    thread_id = "thread-1"
    uid = "user-1"
    dir_virtual_path = "/home/gem/projects/project-workdir-1/directory"
